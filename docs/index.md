...
[Application Context](https://mapstore.readthedocs.io/en/latest/map-portal/managing-contexts/) where users can save, manage and share its own resources by also managing access permissions to other groups of users.
